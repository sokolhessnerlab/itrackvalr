...
Then, load behavioral response data for each participant. The following chunk calls `itrackvalr` functions to load CSVs for participants' extracted behavioral data. The function returns assigns a list of these loaded dataframes that we assign to `behavioral_df_list`.
